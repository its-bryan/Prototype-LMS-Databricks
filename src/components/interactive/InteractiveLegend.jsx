      ...
      <div className="max-w-2xl space-y-2">
                            ...
                            {isEditing ? (
                              <div className="flex-1 flex items-center gap-2">
                                <input
                                  ...
                                  className="flex-1 px-2 py-1 border border-[#FFD100] rounded text-sm focus:outline-none"
                                  autoFocus
                                />
                                <button
                                  onClick={saveEdit}
                      ...
                      {addingTo === catIdx ? (
                        <div className="flex items-center gap-2 pt-1">
                          <input
                            ...
                            className="flex-1 px-2 py-1 border border-[#E6E6E6] rounded text-sm focus:outline-none focus:border-[#FFD100]"
                            autoFocus
                          />
                          <button
                        ...
                        <div className="flex items-center justify-between pt-1 pb-1">
                          <button
                            ...
                            className="text-xs text-[#FFD100] font-medium hover:underline cursor-pointer"
                          >
                            + Add Reason
                          </button>
                          <button
        ...
        {addingCategory ? (
          <div className="flex items-center gap-2 pt-2">
            <input
              ...
              className="flex-1 px-3 py-2 border border-[#E6E6E6] rounded text-sm focus:outline-none focus:border-[#FFD100]"
              autoFocus
            />
            <button
              onClick={addCategory}
              className="px-3 py-2 bg-[#FFD100] text-[#1A1A1A] rounded text-xs font-medium hover:bg-[#E6BC00] transition-colors cursor-pointer"
            >
              Add
            </button>
            <button
          ...
          <button
            ...
            className="w-full py-2.5 border-2 border-dashed border-[#E6E6E6] rounded-lg text-xs text-[#6E6E6E] font-medium hover:border-[#FFD100] hover:text-[#1A1A1A] transition-colors cursor-pointer"
          >
            + Add Category
          </button>
        )}
        ...
        <div className="flex items-center gap-3 justify-end pt-4">
          <button
            ...
            className="px-4 py-2 bg-[#FFD100] text-[#1A1A1A] rounded text-sm font-medium hover:bg-[#E6BC00] transition-colors cursor-pointer"
          >
            Publish Changes
          </button>
          {isSaved && (
