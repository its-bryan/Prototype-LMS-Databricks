  ...
  const points = useMemo(
    () =>
      buildTrendPoints({
        ...
        granularity,
        metricMode: "stackedLeads",
        selectedZones,
        selectedGms,
        selectedAms,
      }),
    [observatorySnapshot, granularity, selectedZones, selectedGms, selectedAms]
  );
  ...
  return (
    <div className="px-6 py-5 space-y-4 text-[var(--hertz-black)]">
      <div>
        ...
        <p className="text-sm text-[var(--neutral-600)] mt-1">Lead composition across the company: rented, cancelled, and unused.</p>
      </div>
