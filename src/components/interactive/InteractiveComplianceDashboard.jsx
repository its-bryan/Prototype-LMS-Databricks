...
export default function InteractiveComplianceDashboard() {
  ...
  const summaryCards = [
    ...
    { label: "Unused Overdue", value: String(stats.unusedOverdue), color: "text-[#FFD100]" },
    ...
    <div>
      ...
      <div className="flex items-center gap-3 mb-4">
        ...
        <select
          ...
          className="px-3 py-1.5 border border-[#E6E6E6] rounded text-xs text-[#1A1A1A] bg-white focus:outline-none focus:border-[#FFD100]"
        >
          <option>All</option>
      ...
      <div className="mt-6 flex gap-3">
        ...
        <button
          ...
          className="px-4 py-2 border border-[#E6E6E6] text-[#1A1A1A] rounded text-sm font-medium hover:border-[#FFD100] transition-colors cursor-pointer"
        >
          Spot Check
        </button>
      </div>
