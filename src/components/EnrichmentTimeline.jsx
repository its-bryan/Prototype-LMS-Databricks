...
const roleStyles = {
  ...
  gm: { color: "#FFD100", bg: "bg-amber-50", border: "border-amber-200", label: "GM" },
};
...
export default function EnrichmentTimeline({ entries = [] }) {
  if (entries.length === 0) {
    return (
      <div>
        <h3 className="text-xs font-bold text-[#6E6E6E] uppercase tracking-wide mb-2">
          Comment History
        </h3>
  ...
  return (
    <div>
      <h3 className="text-xs font-bold text-[#6E6E6E] uppercase tracking-wide mb-3">
        Comment History
      </h3>
