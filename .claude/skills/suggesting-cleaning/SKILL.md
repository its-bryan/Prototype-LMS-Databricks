...
**IMPORTANT**: This skill executes `scripts/run_suggesting_cleaning.py`. Do NOT re-implement the logic inline.
...
```bash
# Basic usage
python scripts/run_suggesting_cleaning.py <input>

# With options
python scripts/run_suggesting_cleaning.py <input> --format json
```
