...
**IMPORTANT**: This skill executes `scripts/run_coding_analysis.py`. Do NOT re-implement the logic inline.
...
```bash
# Basic usage
python scripts/run_coding_analysis.py <input>

# With options
python scripts/run_coding_analysis.py <input> --format json
```
