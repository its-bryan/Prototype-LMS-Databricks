...
const selectClass =
  "px-3 py-1.5 border border-[#E6E6E6] rounded text-xs text-[#1A1A1A] bg-white focus:outline-none focus:border-[#F5C400]";
  ...
  return (
    <div>
      ...
      <div className="flex items-center gap-2 flex-wrap mb-3">
        ...
        <span className="text-[#E6E6E6] mx-1">|</span>
        ...
        {useCustom && (
          <div className="flex items-center gap-2 ml-1">
            <input
              ...
              className="px-2 py-1 border border-[#E6E6E6] rounded text-xs text-[#1A1A1A] focus:outline-none focus:border-[#F5C400]"
            />
