...
| Primary accent | `#FFD100` | Highlights, active states, badges (used sparingly) |
...
- "Hertz" wordmark top-left (charcoal + gold underline)
...
- Each card has a line icon, role name, one-line description, gold left-border on hover
